                    ...
                    <form action="{{ route('schedules.update', $schedule) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="patient_id" name="patient_id" value="{{ $schedule->patient_id }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="vaccine_id" class="form-label">
                                    <i class="fas fa-vial"></i> Vaccine ID
                                </label>
                                <input type="number" class="form-control" id="vaccine_id" name="vaccine_id" value="{{ $schedule->vaccine_id }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="dose_number" name="dose_number" value="{{ $schedule->dose_number }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3">{{ $schedule->notes }}</textarea>
                        </div>
